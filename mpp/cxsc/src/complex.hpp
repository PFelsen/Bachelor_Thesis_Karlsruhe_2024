...
{  
   ...
   public:
      ...
      constexpr complex(void)             {}
      //! Constructor of class complex
      constexpr complex(const real & a,const real & b)  : re(a), im(b) { }
      
      //! Implementation of standard assigning operator
      constexpr inline complex & operator= (const real & r)  {
        re = r;
        im = 0.0;
        return *this;
      }
      ...
      //! Constructor of class complex
      constexpr explicit inline complex(const real &r)  : re(r), im(0.0)     {}
