...
class cinterval
{
   ...
   public:
      ...
      constexpr inline cinterval(void)             {}
      //! Constructor of class cinterval
      constexpr inline cinterval(const interval & a,const interval &b)  : re(a), im(b) {}
      //! Constructor of class cinterval
      inline cinterval(const complex & a,const complex & b)   : re(Re(a),Re(b)),
                                                                                          im(Im(a),Im(b)) {
      ...
      //! Constructor of class cinterval
      constexpr explicit inline cinterval(const real     & a)   : re(a,a), im(0,0) {}
      //! Constructor of class cinterval
      constexpr explicit inline cinterval(const interval & a)   : re(a), im(0,0) {}
      //! Constructor of class cinterval
      explicit inline cinterval(const complex  & a)   : re(Re(a),Re(a)),im(Im(a),Im(a)) {}
      //! Constructor of class cinterval
      ...
      constexpr inline cinterval & operator =(const real &a)  {
        re=a,im=0.0;
        return *this;
      }
      //! Implementation of standard assigning operator
      constexpr inline cinterval & operator =(const interval &a)  {
        re=a,im=0.0;
        return *this;
      }
      //! Implementation of standard assigning operator
      ...
      //! Implementation of standard assigning operator
      constexpr inline cinterval & operator =(const cinterval &a)  {
        re=a.re;
        im=a.im;
        return *this;
      }
