...
class real
{
   ...
   public:
      ...
      constexpr real(void)   : w(0.0)         { }
      //! Constructor of class real
      constexpr real(const float  &a)  : w(a) { }
      //! Constructor of class real
      constexpr real(const double &a)  : w(a) { }
      //! Constructor of class real
      constexpr real(const int     a)  : w(a) { }
      //! Constructor of class real
      constexpr real(const long    a)  : w(a) { }
      ...
      */
      ...
      friend inline constexpr bool operator<  (const real& a, const real& b) ;
